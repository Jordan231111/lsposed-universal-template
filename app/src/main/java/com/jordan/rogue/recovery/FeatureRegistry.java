...
public final class FeatureRegistry {
    ...
    public static final String KEY_FORGE_BACKUP_SUCCESS = "forge_backup_success";
    public static final String KEY_GAME_SPEED_MULTIPLIER = "game_speed_multiplier";
    ...
    public static synchronized void initialize(Context ctx) {
        ...
        register(Feature.bool(KEY_SERVER_INTEGRITY_BYPASS,
                "Repair cloud integrity request (native)",
        ...
        register(Feature.bool(KEY_FORGE_BACKUP_SUCCESS,
                "Forge IssueBackupKey/VerifyBackupKey success (native)",
                TemplateConfig.ENABLE_FORGE_BACKUP_SUCCESS));
        register(Feature.number(KEY_GAME_SPEED_MULTIPLIER, "Game speed multi",
                TemplateConfig.DEFAULT_GAME_SPEED_MULTIPLIER, 1f, 10f));
