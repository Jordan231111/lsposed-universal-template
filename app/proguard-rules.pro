...
# LSPatch resolves this classic entry class by string from assets/xposed_init.
-keep class com.jordan.rogue.recovery.classic.ClassicEntry { *; }
...
# Classic Xposed API is compileOnly for the LSPatch flavor and supplied by LSPatch at runtime.
